<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4"> 
                <div class="card-body">
                    <button type="button" class="btn btn-primary mb-2" wire:click="createNewPatient">
                       <i class="ti ti-user-plus"></i> Tambah Pasien Baru
                    </button>

                    <!-- Search Section -->
                    <div class="mb-2">
                        <label for="searchQuery" class="form-label">Cari Pasien</label>
                        <input type="text" 
                            class="form-control" 
                            id="searchQuery"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('doctorCode') is-invalid @enderror" id="doctorCode" wire:model="doctorCode">
